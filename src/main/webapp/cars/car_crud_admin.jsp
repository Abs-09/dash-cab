    ...
    <body>
        ...
        <section class="home-section">
            ...
            <div class="container">
                <div class="inbox-container">
                    <div class="button-container">
                        ...
                        <button class="button" onclick="openEditPopup(null)">Add New Car</button>
                    </div>
                    <table>
                        <tr>
                            <th>ID</th>
            ...
            <div class="overlay" id="overlay">
                <div class="popup">
                    <h2 id="popupTitle" >Add New Car</h2>
        ...
        <script>
            ...
            function openEditPopup(id) {
                if (id !== null) {
                    ...
                    // Reset fields for adding new Car
                    ...
                    document.getElementById("popupTitle").textContent = "Add New Car";
                    // Show the popup
                    document.getElementById('overlay').style.display = "flex";
                }
